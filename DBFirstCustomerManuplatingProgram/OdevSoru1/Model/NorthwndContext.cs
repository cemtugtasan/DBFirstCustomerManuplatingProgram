...
public partial class NorthwndContext : DbContext
{
    ...
    public virtual DbSet<Sonuc> Sonucs { get; set; }

    public virtual DbSet<Soru1> Soru1s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-55D3033\\MSSQLSERVER01;Database=NORTHWND;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Sonuc>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Sonuc");

            entity.Property(e => e.Sonuc1).HasColumnName("Sonuc");
        });

        modelBuilder.Entity<Soru1>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Soru1");

            entity.Property(e => e.Tamsayi1).HasColumnName("tamsayi1");
            entity.Property(e => e.Tamsayi2).HasColumnName("tamsayi2");
        });
